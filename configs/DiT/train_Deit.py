...
def main(args):
    """
    Trains a new DiTwithDeiT model.
    """
    ...
    model = DiTwithDeiT_models[args.model](
        img_size=latent_size,  # DiTwithDeiT는 img_size로 호출됩니다.
        num_classes=args.num_classes
    )
    # Note that parameter initialization is done within the DiTwithDeiT constructor
